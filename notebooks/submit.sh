...
runai submit \
  ...
  --command -- /bin/bash -lc "\
    ...
    [ -d /scratch/open-project-m3-jpmg ] || git clone https://github.com/CS-552/open-project-m3-jpmg.git /scratch/open-project-m3-jpmg && \
    jupyter lab \
      --ip=0.0.0.0 --port=8888 --no-browser --allow-root \
      --ServerApp.root_dir=/scratch/open-project-m3-jpmg \
