...
CONFIG_PATH="multilingual_transfer/configs/eclektic.yaml"
# ==============================================

# Edit this for your project. Keep outputs/checkpoints under /scratch.
TRAIN_COMMAND="cd /scratch/${REPO_NAME} && pip install -r requirements.txt && pip install -e ./vllm_fuxitranyu && python multilingual_transfer/eclektic_generate.py --config /scratch/${REPO_NAME}/${CONFIG_PATH}"
